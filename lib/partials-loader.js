...
//                              template_root_directories: app.get('views'),
//                              partials_directory_names: 'partials',
//                              template_extensions: app.get('view engine'),
//                              delimiter_symbol: '/'
//                          });
//  partialLoader.handlebars({ template_engine_reference: handlebars, 
//                              template_root_directories: [app.get('views'), '../example/templates/'],
//                              partials_directory_names: ['partials', 'extra_partials'],
//                              template_extensions: [app.get('view engine'), 'handlebars', 'html', 'html'],
//                              delimiter_symbol: '/'
//                          });
